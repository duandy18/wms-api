...
DEV_ENV := WMS_ENV="$(WMS_ENV)" WMS_TEST_DATABASE_URL="$(WMS_TEST_DATABASE_URL)" WMS_DATABASE_URL="$(WMS_DATABASE_URL)" PMS_API_BASE_URL="$(PMS_API_BASE_URL)" OMS_API_BASE_URL="$(OMS_API_BASE_URL)" PROCUREMENT_API_BASE_URL="$(PROCUREMENT_API_BASE_URL)" LOGISTICS_API_BASE_URL="$(LOGISTICS_API_BASE_URL)" PYTHONPATH=.
TEST_ENV := WMS_ENV=test WMS_TEST_DATABASE_URL="$(DEV_TEST_DB_DSN)" WMS_DATABASE_URL="$(DEV_TEST_DB_DSN)" PMS_API_BASE_URL="$(PMS_API_BASE_URL)" OMS_API_BASE_URL="$(OMS_API_BASE_URL)" PROCUREMENT_API_BASE_URL="$(PROCUREMENT_API_BASE_URL)" LOGISTICS_API_BASE_URL="$(LOGISTICS_API_BASE_URL)" PYTHONPATH=.
