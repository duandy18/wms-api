# app/pms/fsku/routers/router_fskus_routes_crud.py
...
from app.pms.fsku.contracts.fsku import (
    FskuCreateIn,
    FskuDetailOut,
...
def register(r: APIRouter) -> None:
    ...
    def list_(
        ...
        store_id: int | None = Query(None, ge=1, description="保留查询上下文；PMS FSKU 主数据不按店铺过滤"),
